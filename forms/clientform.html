         ...
         <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation" aria-label="Main navigation" data-accordion="false" id="navigation">
                      <a href="C:\xampp\htdocs\Day43\WMS\index.html" class="nav-link">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
          <div class="card p-4 bg-white">
            <h2 class="text-center mb-4">Client Registration Form</h2>
            <form action="http://localhost:8080/Wedding/client/insert_client.php" width="100%" height="600"  method="POST">
