...
// Optional: send cache control headers
...
<html lang="en">
  ...
  <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <nav class="mt-2">
                  ...
                  <p>
                    Dashboard
                       ...
                       <li class="nav-item">
                    <a href="../WMS/forms/admission.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Client</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../WMS/forms/vendor.html" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Vendor</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../WMS/forms/event.html" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Event</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../WMS/forms/payment.html" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Payments</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="C:\xampp\htdocs\Day43\WMS\forms\staff.html"class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Staff</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../WMS/forms/venue.html" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Venue</p>
                    </a>
                  </li>
    ...
    <script>
  // Ping the server to check session status
